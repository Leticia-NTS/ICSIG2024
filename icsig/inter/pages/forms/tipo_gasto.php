     ...
     <div class="container-fluid">
          ...
          <div class="col-12">
              ...
              <div class="modal-dialog modal-lg" role="document">
                ...
                <form id="fajax" method="POST">  
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese el tipo de gasto</h1>
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                             ...
                             <div class="col-md-auto">
                                <label>Nota</label>
                                <textarea class="form-control" rows="3" name="nota" id="nota" placeholder="Ingrese..."></textarea>
                            </div>
                             <div class="col-md-8">
                                <label>Línea</label>
            ...
            <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="editarm" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title">Edite el tipo de gasto</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
        ...
        <div class="modal fade" id="desactivar" tabindex="-1" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title">Desactive el tipo de gasto</h1>
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-head-fixed text-nowrap" id="tablatgasto">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/tipo_gasto/registrostipogasto.php",
				data:datos,
				success:function(){
...
<script>
	$.ajax({
		url: "../../pages/conexiones/tipo_gasto/mostrartipogasto.php",
		type: "POST",
		cache: false,
		success: function(data){
			$('#tablatgasto').html(data); 
		}
	});
</script>    
<script>
...
function mostrarmodal() {
  var idtgasto=document.querySelector("input[type=checkbox]:checked");
    if(idtgasto){ 
            $.ajax({
				type:"POST",
				url:"../../pages/conexiones/tipo_gasto/mostrarlistatgasto.php",
				data:"idtgasto="+idtgasto.value,
				success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/tipo_gasto/editartipogasto.php",
				data:datos2,
				success:function(){
                    refrescar();
                    $('#editar').modal('hide');
                    ...
                    document.getElementById('notaorig').value="";
...
if(eliminard){
    console.log(eliminard)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/tipo_gasto/desactivartipogasto.php",
