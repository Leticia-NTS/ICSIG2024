     ...
     <div class="container-fluid">
          ...
          <div class="col-12">
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese la línea</h1>
            ...
            <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="editarm" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title">Edite la línea</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
        ...
        <div class="modal fade" id="desactivar" tabindex="-1" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title">Desactive la línea</h1>
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <div class="card-body table-responsive p-0" style="height: 400px;">
                 <!--  <table class="table table-hover table-condensed" id="tablalinea"> -->
                <table class="table table-head-fixed text-nowrap" id="tablalinea">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/linea/registrolinea.php",
				data:datos,
				success:function(){
...
<script>
	$.ajax({
		url: "../../pages/conexiones/linea/mostrarlinea.php",
		type: "POST",
		cache: false,
		success: function(data){
			$('#tablalinea').html(data);
		}
	});
</script>   
<script>
...
function mostrarmodal() {
  var idlinea=document.querySelector("input[type=checkbox]:checked");
    if(idlinea){ 
            $.ajax({
				type:"POST",
				url:"../../pages/conexiones/linea/mostrarlistalinea.php",
				data:"idlinea="+idlinea.value,
				success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/linea/editarlinea.php",
				data:datos2,
				success:function(){
                    refrescar();
                    $('#editar').modal('hide');
...
if(eliminard){
    console.log(eliminard)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/linea/desactivarlinea.php",
