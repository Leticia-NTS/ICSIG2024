     ...
     <div class="container-fluid">
          ...
          <div class="col-12">
              ...
              <div class="modal-dialog modal-lg" role="document">
                ...
                <form id="fajax" method="POST">  
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese la marca</h1>
            ...
            <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="editarm" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title">Edite la marca</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
        ...
        <div class="modal fade" id="desactivar" tabindex="-1" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title">Desactive la marca</h1>
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-head-fixed text-nowrap" id="tablamarca">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#btnguardar').click(function(){
      ...
      $.ajax({
        type:"POST",
        url:"../../pages/conexiones/marca/registromarca.php",
        data:datos,
        success:function(){
...
<script>
  $.ajax({
    url: "../../pages/conexiones/marca/mostrarmarca.php",
    type: "POST",
    cache: false,
    success: function(data){
      $('#tablamarca').html(data); 
    }
  });
</script>    
<script>
...
function mostrarmodal() {
  var idmarca=document.querySelector("input[type=checkbox]:checked");
    if(idmarca){ 
            $.ajax({
        type:"POST",
        url:"../../pages/conexiones/marca/mostrarlistamarca.php",
        data:"idmarca="+idmarca.value,
        success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
      $.ajax({
        type:"POST",
        url:"../../pages/conexiones/marca/editarmarca.php",
        data:datos2,
        success:function(){
                    refrescar();
                    $('#editar').modal('hide');
...
if(eliminard){
    console.log(eliminard)
      $.ajax({
        type:"POST",
        url:"../../pages/conexiones/marca/desactivarmarca.php",
