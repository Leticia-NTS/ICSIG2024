     ...
     <div class="container-fluid">
          ...
          <div class="col-12">
              ...
              <div class="modal-dialog modal-lg" role="document">
                ...
                <form id="fajax" method="POST">  
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese la sucursal</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <textarea class="form-control" rows="3" name="ubiacion" id="ubicacion" placeholder="Ingrese..."></textarea>
                                </div>
                             <div class="row">
                                 <div class="col-md-4">
                                        <label>Teléfono</label>
                                        <input type="number" name="telefono" id="telefono" class="form-control"  placeholder="xxxx-xxxx">
                                 </div>
                                <div class="col-md-4">
                                     <label>Celular</label>
                                     <input type="number" name="celular" id="celular" class="form-control"  placeholder="xxxx-xxxx">
                                </div>
                                <div class="col-md-6">
                                     <label>Correo electrónico</label>
                                     <input type="email" name="correo" id="correo" class="form-control"  placeholder="IngreseCorreo@Electronico.com">
                                </div>
                             </div>
            ...
            <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="editarm" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title">Edite la sucursal</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
        ...
        <div class="modal fade" id="desactivar" tabindex="-1" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title">Desactive la sucursal</h1>
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-head-fixed text-nowrap" id="tablasucursal">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sucursal/registrosucursal.php",
				data:datos,
				success:function(){
...
<script>
	$.ajax({
		url: "../../pages/conexiones/sucursal/mostrarsucursal.php",
		type: "POST",
		cache: false,
...
function mostrarmodal() {
  var idsucursal=document.querySelector("input[type=checkbox]:checked");
    if(idsucursal){ 
            $.ajax({
				type:"POST",
				url:"../../pages/conexiones/sucursal/mostrarlistasucursal.php",
				data:"idsucursal="+idsucursal.value,
				success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sucursal/editarsucursal.php",
				data:datos2,
				success:function(){
                    refrescar();
                    $('#editar').modal('hide');
                    ...
                    document.getElementById('ubicacionorig').value="";
...
if(eliminard){
    console.log(eliminard)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sucursal/desactivarsucursal.php",
