              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese la factura de compra</h1>
                  ...
                  <div class="card card-outline card-success">
                    <div class="card-body">
                     <div class="form-group">
                         <div class="col-md-3">
                                <input type="hidden" name="usuario" id="usuario" class="form-control" value="<?php echo $usuario?$usuario['id_usuario']:''?>" placeholder="usuario">
                        </div>
                        ...
                        <div class="input-group col-md-4 ml-md-auto">
                              ...
                              <div class="col-12">
                                <div class="card">
                                  ...
                                  <div class="card-body table-responsive p-0" style="height: 400px;">
                                    ...
                                    <table class="table table-head-fixed text-nowrap" id="tablaingresar">
                                     <thead >
                                        <tr>
                      ...
                      <div class="row">                                    
                          <div class="col-md-4">
                            <button id="table2-new-row-button" class="btn btn-success">Añadir producto</button>
                              </div>
                           <div class="col-md-4 ml-md-auto">
                                  <label>Total</label>
                                  <input type="text" name="totalm" id="totalm" class="form-control"  placeholder="00,000.00">
                           </div>
                      </div>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-hover table-condensed" id="tablagasto">
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){            
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/gasto/#.php",             
        data:'tabla='+JSON.stringify(datos)+"&totalm="+totalm.value,
				success:function(){
                     location.reload();
                }					
			});  
...
function guardarcambio() {   
    console.log("uwu ");
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/gasto/#.php",             
        data:"descripcion="+trs[i].querySelector('input[name*="descripcionorig"]').value+ 
                "&gasto="+trs[i].querySelector('input[name*="montoorig"]').value+ "&tgasto="+trs[i].querySelector('select[name*="tgastoorig"]').value+
                "&ideditgasto="+trs[i].querySelector('input[name*="ideditgasto"]').value,
				success:function(){
                    location.reload();
...
function cambiarvista(valor) {
  var mostrardesactiva=valor;
    console.log(mostrardesactiva)
            $.ajax({
                type:"POST",
                url:"../../pages/conexiones/gasto/m#.php",
