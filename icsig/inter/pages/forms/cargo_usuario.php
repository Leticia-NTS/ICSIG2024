      ...
      <div class="container-fluid">
        <div class="row justify-content-md-center">
          <div class="col-sm-auto">
            <h1>Sección cargo de usuario</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese el cargo de usuario</h1>
                  ...
                  <div class="card card-outline card-success">
                    ...
                    <div class="row justify-content-end">                            
                     ...
                     <div class="form-group">
                         <div class="col-md-6">
                            <label>Nombre del cargo de usuario</label>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-head-fixed text-nowrap" id="tablacargo">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/cargo_usuario/registrocargo.php",
				data:datos,
				success:function(){
...
<script>
	$.ajax({
		url: "../../pages/conexiones/cargo_usuario/mostrarcargo.php",
		type: "POST",
		cache: false,
		success: function(data){
			$('#tablacargo').html(data); 
		}
	});
</script>   
<script>
...
function mostrarmodal() {
  var idcargo=document.querySelector("input[type=checkbox]:checked");
    if(idcargo){ 
            $.ajax({
				type:"POST",
				url:"../../pages/conexiones/cargo_usuario/mostrarlistacargo.php",
				data:"idcargo="+idcargo.value,
				success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/cargo_usuario/editarcargo.php",
				data:datos2,
				success:function(){
                    refrescar();
                    $('#editar').modal('hide');
...
if(eliminard){
    console.log(eliminard)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/cargo_usuario/desactivarcargo.php",
