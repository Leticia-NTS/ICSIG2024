      ...
      <div class="container-fluid">
        <div class="row justify-content-md-center">
          <div class="col-sm-auto">
            <h1>Sección sub-categoría de productos</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
     ...
     <div class="container-fluid">
          ...
          <div class="col-12">
              ...
              <div class="modal-dialog modal-lg" role="document">
                ...
                <form id="fajax" method="POST">  
                  <div class="modal-header">
                    <h1 class="modal-title" id="añadirm">Ingrese la sub-categoría del producto</h1>
            ...
            <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="editarm" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title">Edite la sub-categoría del producto</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
        ...
        <div class="modal fade" id="desactivar" tabindex="-1" role="dialog" aria-labelledby="modalDelete" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title">Desactive la sub-categoría del producto</h1>
              ...
              <div class="modal-footer d-flex justify-content-center deleteButtonsWrapper">
                ...
                <table class="table table-head-fixed text-nowrap" id="tablasubcategoria">  
                </table>
                </div>
                <tfoot>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnguardar').click(function(){
			...
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sub_categoria/registrossubcategoria.php",
				data:datos,
				success:function(){
...
<script>
	$.ajax({
		url: "../../pages/conexiones/sub_categoria/mostrarsubcategoria.php",
		type: "POST",
		cache: false,
		success: function(data){
			$('#tablasubcategoria').html(data); 
		}
	});
</script>    
<script>
...
function mostrarmodal() {
  var idsubcategoria=document.querySelector("input[type=checkbox]:checked");
    if(idsubcategoria){ 
            $.ajax({
				type:"POST",
				url:"../../pages/conexiones/sub_categoria/mostrarlistasubcategoria.php",
				data:"idsubcategoria="+idsubcategoria.value,
				success:function(data){
...
function guardarcambio() {
  var datos2=$('#formeditar').serialize();
    console.log(datos2)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sub_categoria/editarsubcategoria.php",
				data:datos2,
				success:function(){
                    refrescar();
                    $('#editar').modal('hide');
...
if(eliminard){
    console.log(eliminard)
			$.ajax({
				type:"POST",
				url:"../../pages/conexiones/sub_categoria/desactivarsubcategoria.php",
